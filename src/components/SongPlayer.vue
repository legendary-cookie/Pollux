    ...
    >
      ...
      >
        ...
        <div class="min-w-0 flex-auto space-y-0.5">
          ...
          <p
            class="text-gray-600 dark:text-gray-500 text-sm sm:text-base lg:text-sm xl:text-base font-medium"
          >
            {{ song.album }}
          </p>
        </div>
  ...
  methods: {
    ...
    forward() {
      this.$refs.audioPlayer.currentTime =
        this.$refs.audioPlayer.currentTime + 30;
    },
    backward() {
      this.$refs.audioPlayer.currentTime =
        this.$refs.audioPlayer.currentTime - 30;
